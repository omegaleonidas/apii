...
<div class="row">
    <div class ="form-group ">
<form action="/report/tanggal/{{$absensi1 -> nip}}" method="POST"  enctype="multipart/form-data">
@csrf
...
<button  class="btn btn-primary btn-sm" >Cetak</button>
   ...
   <a href="/report/detailPDF/{{$absensi1 -> nip}}" class="btn btn-sm btn-success" > PDF </a>
            <a href="/report/detailPrint/{{$absensi1 -> nip}}" class="btn btn-sm btn-success" > Print</a>
